...
memberlimit = 2
name = "RARA CANS"
rdaftar = "*_SUBSCRIBE ZEROツ"
rmenu = "*_SUBSCRIBE ZEROツ"
botinfo = "HINATA BOTz"
fake = '*_HINATA-BOTz-ANTIDELETE_*'
ator = 'SUBSCRIBE'
namo = 'RARA CANS'
cr = "~*SUBSCRIBE ZEROツ🍁~OWNER:RARA CANS🍁*"

/******** OWNER NUMBER**********/
const ownerNumber = ["15203376538@s.whatsapp.net"] //NOMOR LUH
const premium = ["15203376538@s.whatsapp.net","6282254187237@s.whatsapp.net","62814622392081@s.whatsapp.net","6281227825649@s.whatsapp.net","62881024843786@s.whatsapp.net","6285850763057@s.whatsapp.net","6285869225011@s.whatsapp.net","6285656214208@s.whatsapp.net"]
/************************************/
...
┃□││❏Ramlan ID
╰─────────────────┈ ❁ཻུ۪۪⸙͎`
MrG.sendMessage(from, tod, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "productMessage":{"product":{"productImage":{"mimetype":"image/jpeg","height":736,"width":736,"jpegThumbnail":fs.readFileSync(`./images.jpg`)},"productId":"3937202479680283","title":"𝐇𝐈𝐍𝐀𝐓𝐀 𝐁𝐎𝐓𝐙","currencyCode":"RP","priceAmount1000":"999999999000","productImageCount":1},"businessOwnerJid":"0@s.whatsapp.net"}}}, contextInfo: { forwardingScore: 508, isForwarded: true, mentionedJid: [ow]}, caption: Mr})
            break
...
case 'mining':
            ...
            case 'creator':
                  ...
                  MrG.sendMessage(from, '*_OWNER PALING CANS DI INDONESIA TwT_*',MessageType.text, { quoted: mek} )
...
if (budy.includes(`Woy`)) {
        ...
        if (budy.includes(`YOUTUBE`)) {
                  reply(`YOUTUBE OWNER KAN`)
                  reply(`NTAR DULU`)
                  reply(`NIH BERO`)
                  reply(`https://youtube.com/channel/UCQ4NgQcaudt9RfnJzPU6jVg`)
                  reply(`SUBSCRIBE YAK`)
                  }
